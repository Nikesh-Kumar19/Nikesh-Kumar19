# -*- coding: utf-8 -*-
"""
Created on Sat Oct 29 10:30:50 2022
...
if uploaded_file is not None:     
    ...
    g = nx.from_pandas_edgelist(data, source = "Origin_code", target = "Dest_code") #Use the Graph API to create an empty network graph object
